					...
					<div class="container">
						<div class="row">
							<div class="col-12 col-sm-12 col-md-12 col-lg-12 float-left">
								<div class="wt-userprofileholder" style="margin-top: 60px;">
											...
											<div class="wt-userprofile">
												...
												<div class="wt-title">
													...
													<span>5/5 <a class="#">(6 Feedback)</a>
														...
														<a href="my-profile-edit.php" class="wt-reportuser"> <i class="far fa-edit" style="font-size: 20px;"></i> Edit</a>
														</span>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div id="wt-statistics" class="wt-statistics wt-profilecounter">
												...
												<div class="wt-statisticcontent wt-countercolor2">
													<h3 data-from="0" data-to="1503" data-speed="8000"
														data-refresh-interval="100">1503</h3>
										...
										<div class="wt-clientfeedback">
											<div class="wt-usertitle wt-titlewithselect">
												...
												<div class="form-group">
													<!-- <a href="my-profile-edit.php" class="wt-reportuser"> <i class="far fa-edit" style="font-size: 20px; float:right;"></i> </a> -->
