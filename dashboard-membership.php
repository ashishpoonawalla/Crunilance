						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 float-left">
							<div class="wt-dashboardbox">
								...
								<div class="wt-dashboardboxcontent wt-packages">
									<div class="wt-package wt-packagedetails" style="border-bottom: 1px dashed grey;">
									<div class="wt-packagehead" >

                                            <?php if (strtoupper($_SESSION["membership"]) == "FREE"){  ?>
									...
									<div class="wt-package wt-baiscpackage" style="border-bottom: 1px dashed grey;">
										<div class="wt-packagehead">

                                            <?php if (strtoupper($_SESSION["membership"]) == "BASIC"){  ?>
                                                <span class="wt-featuredtag"><i class="fa fa-star"></i></span>
                                            <?php }		?>
										...
										<div class="wt-packagecontent">
											...
											<a class="wt-btn" href="dashboard-accountsettings.php?var=Baisc"><span>Upgrade</span></a>
										</div>
									</div>
									<div class="wt-package wt-standardpackage" style="border-bottom: 1px dashed grey;">
										<div class="wt-packagehead">

                                            <?php if (strtoupper($_SESSION["membership"]) == "STANDARD"){  ?>
                                                <span class="wt-featuredtag"><i class="fa fa-star"></i></span>
                                            <?php }		?>
										...
										<div class="wt-packagecontent">
											...
											<a class="wt-btn" href="dashboard-accountsettings.php?var=Standard"><span>Upgrade</span></a>
										</div>
									</div>
									<div class="wt-package wt-extendedpackage" style="border-bottom: 1px dashed grey;">
										<div class="wt-packagehead">

                                            <?php if (strtoupper($_SESSION["membership"]) == "PROFESSIONAL"){  ?>
                                                <span class="wt-featuredtag"><i class="fa fa-star"></i></span>
                                            <?php }		?>
										...
										<div class="wt-packagecontent">
											...
											<a class="wt-btn" href="dashboard-accountsettings.php?var=Professional"><span>Upgrade</span></a>
										</div>
									</div>
								</div>
							</div>
