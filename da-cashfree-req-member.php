...
// $c_name = $_SESSION["first_name"];
// $c_email = $_SESSION["username"];
   
require('db.php');
$sql="INSERT INTO tmp_order(order_id, amount, currency, c_name, c_email) Values('$orderId','$orderAmount','$orderCurrency','$customerName','$customerEmail') " ;
$conn->query($sql);
