							...
							<div class="wt-dashboardbox" >
								...
								<div class="wt-dashboardboxcontent wt-jobdetailsholder">
									...
									<div class="wt-rcvproposalholder wt-hiredfreelancer wt-tabsinfo">
										<div class="wt-tabscontenttitle">
											<h2><?php if ($status1== "Awarded - Pending") echo $status1 ; else echo "Hired Freelancer"; ?>  
											
												- <a href="dashboard-ongoingprogress.php?pid=<?php echo $pid; ?>"  class="wt-btn wt-attachmentbtn" style="flex: right;">
													Manage Job
													</a>
											</h2>		
										</div>
											...
											<ul id="accordion" class="wt-historycontentcol">
												...
												<li class="collapsed" data-toggle="collapse" data-target="#collapse<?php echo $ctt;?>">
													<div class="wt-dateandmsg">
														...
														<span> | <?php echo $date11; ?> | <?php echo $duration; ?> days | $<?php echo $amount; ?></span>
													</div>
