														...
														<fieldset>
															<div class="wt-checkboxholder wt-verticalscrollbar">
																<span class="wt-checkbox">
																	...
																	<label for="wt-description"> <img
																			src="images/flag/img-01.png" alt="">
																		Australia</label>
																</span>
																<span class="wt-checkbox">
																	<input id="us" type="checkbox" name="description"
																		value="company">
																	<label for="us"> <img src="images/flag/img-02.png"
																			alt=""> United States</label>
																</span>
																<span class="wt-checkbox">
																	<input id="canada" type="checkbox"
																		name="description" value="company">
																	<label for="canada"> <img
																			src="images/flag/img-03.png" alt="">
																		Canada</label>
																</span>
																<span class="wt-checkbox">
																	<input id="england" type="checkbox"
																		name="description" value="company">
																	<label for="england"> <img
																			src="images/flag/img-04.png" alt="">
																		England</label>
																</span>
																<span class="wt-checkbox">
																	<input id="emirates" type="checkbox"
																		name="description" value="company">
																	<label for="emirates"> <img
																			src="images/flag/img-05.png" alt=""> United
																		Emirates</label>
																</span>
																<span class="wt-checkbox">
																	<input id="wt-description1" type="checkbox"
																		name="description" value="company">
																	<label for="wt-description1"> <img
																			src="images/flag/img-01.png" alt="">
																		Australia</label>
																</span>
																<span class="wt-checkbox">
																	<input id="us1" type="checkbox" name="description"
																		value="company">
																	<label for="us1"> <img src="images/flag/img-02.png"
																			alt=""> United States</label>
																</span>
															</div>
														</fieldset>
											...
											<div class="wt-companysinfoholder">
												<div class="row">
													<div class="col-12 col-sm-12 col-md-12 col-lg-6">
														<div class="wt-companysdetails">
															...
															<div class="wt-companysinfo">
																<figure><img src="images/company/img-01.png" alt="">
																</figure>
																<div class="wt-title">
																	<a href="#"><i
													...
													<div class="col-12 col-sm-12 col-md-12 col-lg-6">
														<div class="wt-companysdetails">
															<figure class="wt-companysimg">
																<img src="images/company/img-02.jpg" alt="">
															</figure>
															<div class="wt-companysinfo">
																<figure><img src="images/company/img-02.png" alt="">
																</figure>
																<div class="wt-title">
																	<a href="#"><i
																			class="fa fa-check-circle"></i> Verified
													...
													<div class="col-12 col-sm-12 col-md-12 col-lg-6">
														<div class="wt-companysdetails">
															<figure class="wt-companysimg">
																<img src="images/company/img-03.jpg" alt="">
															</figure>
															<div class="wt-companysinfo">
																<figure><img src="images/company/img-03.png" alt="">
																</figure>
																<div class="wt-title">
																	<a href="#"><i
																			class="fa fa-check-circle"></i> Verified
													...
													<div class="col-12 col-sm-12 col-md-12 col-lg-6">
														<div class="wt-companysdetails">
															<figure class="wt-companysimg">
																<img src="images/company/img-04.jpg" alt="">
															</figure>
															<div class="wt-companysinfo">
																<figure><img src="images/company/img-04.png" alt="">
																</figure>
																<div class="wt-title">
																	<a href="#"><i
																			class="fa fa-check-circle"></i> Verified
													...
													<div class="col-12 col-sm-12 col-md-12 col-lg-6">
														<div class="wt-companysdetails">
															<figure class="wt-companysimg">
																<img src="images/company/img-05.jpg" alt="">
															</figure>
															<div class="wt-companysinfo">
																<figure><img src="images/company/img-05.png" alt="">
																</figure>
																<div class="wt-title">
																	<a href="#"><i
																			class="fa fa-check-circle"></i> Verified
													...
													<div class="col-12 col-sm-12 col-md-12 col-lg-6">
														<div class="wt-companysdetails">
															<figure class="wt-companysimg">
																<img src="images/company/img-06.jpg" alt="">
															</figure>
															<div class="wt-companysinfo">
																<figure><img src="images/company/img-06.png" alt="">
																</figure>
																<div class="wt-title">
																	<a href="#"><i
																			class="fa fa-check-circle"></i> Verified
