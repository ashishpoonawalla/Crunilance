...
if ($txStatus == "SUCCESS")
{
       ...
       if($row300 = $result300->fetch_assoc())
       {
          ...
          // $_SESSION["membershipend"] = $date2;
           ...
           $sql301="UPDATE user_info SET bidcount='$bidcount' Where email='$unm2'" ;                
       

           if($conn->query($sql301))
           {
               $msg="Bid buy successfully";


               //------------------------------- insert to transaction ----------------------------

               $dtl = "Bid buy: $ $var - Bid count $newbid ";
...
header ('Location: da-cashfree-bid-buy-return-1.php');
?>
