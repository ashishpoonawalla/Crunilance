...
if (!isset($_SESSION["auname"])){
  header('Location: http://localhost/Crunilance/Error.php');  
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
   ...
   <!--
      <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/admin_home.php" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/pages/admin/users.php" class="nav-link">User</a>
      </li>
	    <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/pages/admin/sellers.php" class="nav-link">Transporter</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/pages/admin/jobs.php" class="nav-link">Jobs</a>
      </li>
	  <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/pages/admin/awarded.php" class="nav-link">Awarded</a>
      </li>
	 
	  <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/pages/admin/delivered.php" class="nav-link">Delivered</a>
      </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/pages/admin/transaction.php" class="nav-link">Transaction</a>
      </li>
	  <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/pages/admin/withdrawl.php" class="nav-link">Withdrawl</a>
      </li>
	  <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/pages/admin/profile.php" class="nav-link">Profile</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
     ...
     <li class="nav-item d-none d-sm-inline-block">
        <a href="http://localhost/Crunilance/Logout.php" class="nav-link">Logout</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="images/favicon.png" class="brand-image elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Crunilance</span>
    </a>
...
<!-- Sidebar Menu -->
  <nav class="mt-2">
		...
		<?php
    $path1 = "http://localhost/Crunilance/" ;
    ?>       

         
          
     <li class="nav-item  d-sm-inline-block">
        <a href="<?php echo $path1; ?>admin_home.php" class="nav-link">Admin Home<i class="fas fa-angle-right right"></i></a>
    ...
    <li class="nav-item  d-sm-inline-block">
        <a href="<?php echo $path1; ?>pages/admin/jobs_cancel.php" class="nav-link">Cancel Jobs<i class="fas fa-angle-right right"></i></a>
      </li>
    	<li class="nav-item d-sm-inline-block">
...
<?php
  ...
  $sql1="SELECT * FROM projects Where status1='Posted'  " ;
  ...
  $sql1="SELECT * FROM projects Where status1='Delivered' " ;
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="http://localhost/Crunilance/pages/admin/jobs.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="http://localhost/Crunilance/pages/admin/delivered.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="http://localhost/Crunilance/pages/admin/users.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="http://localhost/Crunilance/pages/admin/withdrawl.php" class="small-box-footer">More Info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
...
<!-- -------------------------------------------------- Pending Job Lists -->
        <section class="col-lg-6 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  <a href="<?php echo $path1; ?>pages/admin/jobs_pending.php"><b>Pending Jobs</b></a>
                </h3>
          ...
          $sql1="SELECT * FROM projects $Query1 ORDER BY product_id DESC " ;
...
<section class="col-lg-6 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <!--<i class="fas fa-chart-pie mr-1"></i>-->
                  <a href="#" class="float-right" ><b>Pending User</b></a>
