								...
								<div class="wt-dashboardboxcontent wt-jobdetailsholder">
									...
									<div class="wt-rcvproposalholder wt-hiredfreelancer wt-tabsinfo">
										<div class="wt-tabscontenttitle">
											...
											<?php if ($status1 == "Awarded - Pending" && $tusername == $user){
												?>
												Hired Freelancer - 
													<a href="fr-ongoingjob-accept.php?pid=<?php echo $pid; ?>&psid=<?php echo $psid; ?>&sts=accept"  onclick="return confirm('Are you sure to accept this project ?');" class="wt-btn wt-msgbtn">
														Accept
													</a>
													<a href="fr-ongoingjob-accept.php?pid=<?php echo $pid; ?>&psid=<?php echo $psid; ?>&sts=reject"  onclick="return confirm('Are you sure to reject this project ?');" class="wt-btn wt-attachmentbtn">
														Reject
													</a>
												<?php
											}else{
												?>
													...
													if ($tusername == $user){
														?>
													- <a href="fr-jobprogress.php?pid=<?php echo $pid; ?>"  class="wt-btn wt-attachmentbtn">
														Manage Job
													 </a>
													<?php 		} 		?>
												<?php 
										...
										<div class="wt-historycontent">
											<ul id="accordion" class="wt-historycontentcol">
												<li class="wt-historycolhead">
													<h3><span>Freelancer</span><span>Details</span><span></span>
													</h3>
												</li>
												...
												<li class="collapsed" data-toggle="collapse" data-target="#collapse<?php echo $ctt;?>">
													<div class="wt-dateandmsg">
														...
														<span> <?php echo $duration; ?> days | $<?php echo $amount; ?></span>
													</div>
													<div class="wt-rightarea wt-msgbtns">
														...
														<!-- <a href="messagestart.php?jobid=<?php echo $pid; ?>&psid=<?php echo $psid1; ?>" class="wt-btn wt-msgbtn">
