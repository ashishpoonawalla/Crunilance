						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-10">
							<div class="wt-dashboardbox" style="min-height: 600px;">
								<div class="wt-dashboardboxtitle wt-featured">
									...
									<h2><?php echo $tit1; ?> - <a href="dashboard-ongoingsingle.php?pid=<?php echo $pid; ?>" style="color: #3B82F6;">Details</a>
                                        <a href="messagestart.php?jobid=<?php echo $pid; ?>&psid=<?php echo $psid; ?>"  style="float: right;">
													...
													<li>
														<div class="wt-accordioninnertitle">
															<span id="accordioninnertitleb" data-toggle="collapse"
																...
																&emsp;<em> $<?php echo $mamount; ?> &emsp; <?php echo $paystatus; ?></em></span>
															<div class="wt-rightarea">
																<!-- <a href="#"
																	...
																	<?php if ($paystatus == "Not Funded"){ ?>
																		<a href="dashboard-ongoingprogress-fund.php?id=<?php echo $id; ?>&pid=<?php echo $pid; ?>&psid=<?php echo $psid; ?>&mamt=<?php echo $mamount; ?>" class="wt-deleteinfo wt-msgbtn" style="width: 100px;" 
																		onclick="return confirm('Are you sure to fund this ?');"
																		><i
																		class="lnr lnr-license"></i> Fund now</a>
																	<?php } ?>


																	<?php if ($paystatus == "Funded"){ ?>
																		<a href="dashboard-ongoingprogress-rele.php?id=<?php echo $id; ?>&pid=<?php echo $pid; ?>&psid=<?php echo $psid; ?>&mamt=<?php echo $mamount; ?>" class="wt-deleteinfo wt-deleteinfo" style="width: 100px;" 
																		onclick="return confirm('Are you sure to release fund ?');"
																		> Fund Release</a>
																	<?php } ?>
                        ...
                        <div class="form-group">
							...
							if ($per == 100){
								...
								<a href="#" class="wt-btn" style="margin-top: 10px;"
									data-toggle="modal"
									data-target="#wt-projectmodalbox">My Review as Employer</a>
								<?php
								}else {
...
?>
	...
	<div class="wt-uploadimages modal fade" id="wt-projectmodalbox" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="wt-modaldialog modal-dialog" role="document">
			<div class="wt-modalcontent modal-content">
				<div class="wt-boxtitle">
					<h2>Employer review to Freelancer<i class=" wt-btncancel fa fa-times" data-dismiss="modal" aria-label="Close"></i>
					</h2>
				</div>
				<div class="wt-modalbody modal-body">
				<form class="wt-formtheme wt-formfeedback" method="post" action="dashboard-ongoingprogress_code.php">
						<fieldset>
							<div class="form-group">
					...
					<!-- <form method="POST" action="dashboard-ongoingprogress_code.php" class="wt-formtheme wt-formfeedback">
						<fieldset>
							<div class="form-group">
								<textarea name="feedback"class="form-control" placeholder="Add Your Feedback*"></textarea>
								<input type="hidden" name="pid" class="form-control" value="<?php echo $pid; ?>"/>
							...
							<div class="form-group wt-ratingholder">
								<div class="wt-ratepoints">
									<div class="counter wt-pointscounter">5.0</div>
									<div name="behaviour" id="wt-jrate" class="wt-jrate"></div>
								</div>
								<span class="wt-ratingdescription">How was my proffesional behaviour?</span>
							</div>
							<div class="form-group wt-ratingholder">
								<div class="wt-ratepoints">
									...
									<div name="qua_work" id="wt-jrateone" class="wt-jrate"></div>
								</div>
								<span class="wt-ratingdescription">How was my quality of work?</span>
							</div>
							<div class="form-group wt-ratingholder">
								<div class="wt-ratepoints">
									...
									<div name="deadline" id="wt-jratetwo" class="wt-jrate"></div>
								</div>
								<span class="wt-ratingdescription">Was I focused to deadline?</span>
							</div>
							<div class="form-group wt-ratingholder">
								<div class="wt-ratepoints">
									<div class="counterthree wt-pointscounter">5.0</div>
									<div name="services" id="wt-jratethree" class="wt-jrate"></div>
								</div>
								<span class="wt-ratingdescription">Was it worth it having my services?</span>
							</div>
							<div class="form-group wt-btnarea">
								<input type="submit" class="wt-btn" style="border: 0;"value="Send Feedback">
							</div>
						</fieldset>
					</form> -->
				</div>
