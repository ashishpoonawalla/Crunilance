...
if (isset($_SESSION["username"])){
  ...
  $un = $_SESSION["suid"] = $_SESSION["username"] ;  
  $_SESSION["sfnm"] = $_SESSION["first_name"];
//   $_SESSION["simg"] = $_SESSION["uimage"];

  // if ($typ == 'Fixed'){ //------------------- JOB
    
    $sql222="SELECT * FROM project_user Where psid=$psid" ;
  ...
  // }else{ //------------------- BOOK/SALE
    ...
    if ($sid222 == $un){
      $sql222="SELECT * FROM projects Where product_id=$jobid" ;
      $result222 = $conn222->query($sql222);
