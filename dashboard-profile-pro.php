					...
					<div class="row">
						...
						<?php
                            ...
                            if (isset($_REQUEST['id'])){
                                ...
                                $sql="DELETE FROM user_project WHERE email='$email' AND id=$id " ;
                            ...
                            //------------------ Insert Skill -----------------------
                                ...
                                if (isset($_POST['title'])){
                                    ...
                                    // $sql="SELECT * FROM user_skills WHERE email='$email' AND title='$title' " ;
                                    ...
                                    // } else {
                                        ...
                                        try {
                                            ...
                                            $conn1->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                                ...
                                                $stmt = $conn1->prepare("INSERT INTO user_project(email,  title,  weburl, imageurl) 
                                                                                        VALUES (:email, :title, :weburl, :imageurl)");
													...
													<li>
														<div class="wt-accordioninnertitle">
															<div class="wt-projecttitle collapsed"
																...
																<figure><img src="<?php echo $imgurl; ?>" alt="">
																</figure>
																<h3><?php echo $title; ?><span><?php echo $weburl; ?></span>
																</h3>
															</div>
												...
												<ul class="wt-experienceaccordion accordion">
													...
													<li>
														...
														<div class="wt-collapseexp collapse show" id="innertitlebone"
															...
															<form method="POST" action="dashboard-profile-proimg.php" class="wt-formtheme wt-userform" enctype="multipart/form-data">
																	...
																	<div class="form-group ">
																		<input type="text" name="weburl" class="form-control" placeholder="Website Url *" required>
																	</div>
																	...
																	<div class="form-group wt-btnarea">
																		...
																		<input type="submit" style=" text-transform: none;  border: 0px; " class="wt-btn do-login-button" value="Add Project">
