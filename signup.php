						...
						?>
								...
								<div class="wt-sectionhead wt-textcenter" style="background-color: #DEE2EE; border-radius: 8px; padding: 15px; ">
                                    ...
                                    <div class="wt-loginformhold1" >
												...
												<form method="POST" action="signup_code.php" class="wt-formtheme wt-loginform do-login-form" style="margin-top: -30px; ">
													<fieldset>
													  ...
													  <div class="input-icons">
														...
														<div class="form-group" style="margin-bottom: 20px;">
															...
															<input type="password" name="upassword" class="form-control" minlength="8" maxlength="20" required
																placeholder="Password" style="background-color: #f7f7f7; color: #000; font-weight: 500;">
														</div>

														<div class="form-group" style="margin-bottom: 20px;">
															<i class="fa fa-unlock-alt icon"></i>
															<input type="password" name="upassword2" class="form-control" minlength="8" maxlength="20" required
													...
													<!-- <div class="form-group" style="margin-bottom: 20px; ">
														<select name="usertype" class="wt-select" style="text-transform: none; " placeholder="Select user type" required>
														...
														<input type="submit" style="width: 100%; text-transform: none; height: 40px; border: 0px; " class="wt-btn do-login-button" value="Create My Account">
