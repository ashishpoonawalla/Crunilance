			...
			<div class="wt-chatbox">
				<div class="wt-messages wt-verticalscrollbar wt-dashboardscrollbar">
					...
					<div class="wt-memessage wt-readmessage">
						...
						<div class="wt-description">
							<p>Eiusmod tempor incididunt labore et dolore magna aliqiu enim ad minim veniam qiuisru
								exercitation ullamco laborisen nisi ut aliquip exea.</p>
							<div class="clearfix"></div>
				...
				<div class="wt-replaybox">
					...
					<div class="wt-iconbox">
						...
						<a href="#" class="wt-btnsendmsg">Send</a>
					</div>
				</div>
			</div>
			<div id="wt-getsupport" class="wt-themeimgborder"><img src="images/messages/img-12.jpg"
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<strong class="wt-logo"><a href="index-2.php"><img src="images/logo.png"
										...
										<div class="collapse navbar-collapse wt-navigation" id="navbarNav">
											<ul class="navbar-nav">
												<li class="menu-item-has-children page_item_has_children">
													...
													<ul class="sub-menu">
														<li
															class="menu-item-has-children page_item_has_children wt-notificationicon">
															<span class="wt-dropdowarrow"><i
																	class="lnr lnr-chevron-right"></i></span>
															<a href="#">Home</a>
															<ul class="sub-menu">
																<li><a href="index-2.php">Home v1</a></li>
																<li class="wt-newnoti"><a href="indexvtwo.php">Home
																		v2<em>without login</em></a></li>
															</ul>
														</li>
												...
												<form class="wt-formtheme wt-loginform do-login-form">
													<fieldset>
														...
														<div class="wt-logininfo">
															<a href="javascript:;"
																class="wt-btn do-login-button">Login</a>
													...
													<div class="wt-loginfooterinfo">
														<a href="javascript:;" class="wt-forgot-password">Forgot
															password?</a>
											...
											<ul>
												...
												<li class="menu-item-has-children">
													...
													<ul class="sub-menu">
														...
														<li><a href="dashboard-ongoingsingle.php">Ongoing Single</a>
														</li>
													</ul>
												</li>
												<li>
					...
					<div id="wt-verticalscrollbar" class="wt-verticalscrollbar">
						<div class="wt-companysdetails wt-usersidebar">
							<figure class="wt-companysimg">
								<img src="images/sidebar/img-01.jpg" alt="">
							</figure>
							<div class="wt-companysinfo">
								<figure><img src="images/sidebar/img-02.php" alt=""></figure>
								<div class="wt-title">
									<h2><a href="#"> Louanne Mattioli</a></h2>
									<span>Amento Tech</span>
								</div>
								<div class="wt-btnarea"><a href="dashboard-postjob.php" class="wt-btn">Post a Job</a>
								</div>
							</div>
						</div>
						<nav id="wt-navdashboard" class="wt-navdashboard">
							<ul>
								<li class="menu-item-has-children">
									...
									<ul class="sub-menu">
										<li>
											<hr><a href="dashboard-insights.php">Insights</a>
										</li>
										<li>
											<hr><a href="dashboard-freelancer.php">Insights User</a>
										</li>
									</ul>
								</li>
								<li>
								...
								<li class="menu-item-has-children">
									...
									<ul class="sub-menu">
										<li>
											<hr><a href="dashboard-completejobs.php">Completed Jobs</a>
										</li>
										<li>
											<hr><a href="dashboard-canceljobs.php">Cancelled Jobs</a>
										</li>
										<li>
											<hr><a href="dashboard-ongoingjob.php">Ongoing Jobs</a>
										</li>
										<li>
											<hr><a href="dashboard-ongoingsingle.php">Ongoing Single</a>
										</li>
									</ul>
								</li>
								<li>
								...
								<li class="wt-notificationicon menu-item-has-children">
									...
									<ul class="sub-menu">
										<li>
											<hr><a href="dashboard-messages.php">Messages</a>
										</li>
										<li>
											<hr><a href="dashboard-messages2.php">Messages V 2</a>
										</li>
									</ul>
								</li>
								<li>
						...
						<div class="wt-navdashboard-footer">
							<span>Crunilance. ©  All Rights Reserved.</span>
						</div>
					</div>
				</div>
				<!--Sidebar Start-->
													...
													<div class="wt-contenthead">
														...
														<ul class="wt-userlisting-breadcrumb">
															...
															<li><span><img src="images/flag/img-02.png" alt=""> United
																	States</span></li>
															<li><a href="#" class="wt-clicksave"><i
													...
													<div class="wt-rightarea">
														<div class="wt-hireduserstatus">
															...
															<ul class="wt-hireduserimgs">
																<li>
																	<figure><img
																			src="images/user/userlisting/img-01.jpg"
																			alt=""></figure>
																</li>
															</ul>
														</div>
											...
											<div class="wt-userlistinghold wt-featured wt-proposalitem">
												...
												<figure class="wt-userlistingimg">
													<img src="images/user/userlisting/img-01.jpg"
														alt="image description" class="mCS_img_loaded">
												</figure>
												<div class="wt-proposaldetails">
													<div class="wt-contenthead">
														<div class="wt-title">
															<a href="usersingle.php"> Alfredo Bossard</a>
														</div>
													</div>
													<div class="wt-proposalfeedback">
														...
														<span class="wt-starcontent"> 4.5/<i>5</i> <em> (860
																Feedback)</em></span>
													</div>
												</div>
														...
														<fieldset>
															<div class="form-group">
																<span class="wt-select">
																	<select>
																		<option value="" disabled="">Project Status
																		</option>
