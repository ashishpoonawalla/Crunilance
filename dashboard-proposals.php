							...
							<div class="wt-dashboardbox">
								...
								<div class="wt-dashboardboxcontent wt-rcvproposala">
									<div class="wt-userlistinghold wt-featured wt-userlistingvtwo">
										<span class="wt-featuredtag wt-featuredtagcolor3"><img src="images/featured.png"
											...
											<div class="wt-contenthead">
												...
												<ul class="wt-saveitem-breadcrumb wt-userlisting-breadcrumb">
													...
													<li><span><img src="images/flag/img-04.png" alt=""
																class="mCS_img_loaded"> England</span></li>
													<li><a href="#" class="wt-clicksavefolder"><i
											...
											<div class="wt-rightarea">
												<div class="wt-hireduserstatus">
													...
													<ul class="wt-hireduserimgs">
														<li>
															<figure><img src="images/user/userlisting/img-02.jpg" alt=""
																	class="mCS_img_loaded"></figure>
														</li>
														<li>
															<figure><img src="images/user/userlisting/img-03.jpg" alt=""
																	class="mCS_img_loaded"></figure>
														</li>
														<li>
															<figure><img src="images/user/userlisting/img-01.jpg" alt=""
																	class="mCS_img_loaded"></figure>
														</li>
														<li>
															<figure><img src="images/user/userlisting/img-02.jpg" alt=""
														...
														<li>
															<figure><img src="images/user/userlisting/img-05.jpg" alt=""
																	class="mCS_img_loaded"></figure>
														</li>
														<li>
															<figure><img src="images/user/userlisting/img-01.jpg" alt=""
										...
										<div class="wt-managejobcontent">
											<div class="wt-userlistinghold wt-featured wt-proposalitem">
												...
												<div class="wt-rightarea">
													<div class="wt-btnarea">
														<a href="#" class="wt-btn">Hire Now</a>
													</div>
													<div class="wt-hireduserstatus">
														<h5>&#36;30</h5>
											...
											<div class="wt-userlistinghold wt-featured wt-proposalitem">
												...
												<div class="wt-proposaldetails">
													<div class="wt-contenthead">
														<div class="wt-title">
															<a href="usersingle.php"> Alfredo Bossard
															</a>
														</div>
													</div>
													<div class="wt-proposalfeedback">
