...
?>				
				...
				<section class="wt-haslayout wt-dbsectionspace" style="min-height: 600px;">
					...
					<div class="row">
						<div class="col-12 col-sm-12 col-md-12 col-lg-1 float-left" style=" margin-bottom: -20px;">
						</div>
						<div class="col-12 col-sm-12 col-md-12 col-lg-10 float-left" style=" margin-bottom: -20px;">
							<div class="wt-userprofileholder" style="margin-top: 0px; padding: 0px;  ">
							<div class="wt-widget">
										...
										<div class="wt-widgetcontent" style="margin-bottom: -40px;margin-top: -4px; padding: 0px;">
											<div class="wt-widgettag wt-widgettagvtwo">
												...
												<a href="userlisting.php">Discover Freelancer</a>												
												<a href="dashboard-savetalents.php">Saved Freelancer</a>											
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-1">
							...
							<div class="wt-dashboardbox">
								...
								<div class="wt-dashboardboxcontent wt-jobdetailsholder">
									<div class="wt-freelancerholder ">
										...
										<a href="dashboard-ongoingsingle.php?pid=<?php echo $pid1; ?>"  >
																	

										<div class="wt-managejobcontent wt-verticalscrollbar">
											<div class="wt-userlistinghold wt-featured wt-userlistingvtwo" style="border: 1px solid #ddd; margin-bottom: 20px;">
												...
												<div class="wt-userlistingcontent">
													<div class="wt-contenthead">
														...
														<ul class="wt-saveitem-breadcrumb wt-userlisting-breadcrumb">
															...
															<?php 		if ($psid != "1"){ 			?>
															<li><span class="wt-dashboradclock" style="color: red;">
																	<i class="lnr lnr-checkmark-circle"></i> <?php echo $status1; ?></span>
																</li>
