					...
					<div class="row">
						...
						<?php
                            ...
                            if (isset($_REQUEST['id'])){
                                ...
                                $sql="DELETE FROM user_education WHERE email='$email' AND id=$id " ;
                            ...
                            //------------------ Insert Skill -----------------------
                                ...
                                if (isset($_POST['coll_name'])){
                                    ...
                                    // $sql="SELECT * FROM user_skills WHERE email='$email' AND coll_name='$coll_name' " ;
                                    ...
                                    // } else {
                                        ...
                                        try {
                                            ...
                                            $conn1->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                                ...
                                                $stmt = $conn1->prepare("INSERT INTO user_education(email,  coll_name,  course,  startdate,  enddate,  desc1) 
                                                                                        VALUES (:email, :coll_name, :course, :startdate, :enddate, :desc1)");

                                                $stmt->bindParam(':email', $email);
                                                $stmt->bindParam(':coll_name', $coll_name);	
						...
						<div class="wt-dashboardtabs">
							<ul class="wt-tabstitle nav navbar-nav">
								...
								<li class="nav-item"><a class="active" href="dashboard-profile-edu.php">Education</a></li>
									...
									<div class="wt-tabscontent tab-content">
													...
													<li>
														<div class="wt-accordioninnertitle">
															<span id="accordioninnertitleb" data-toggle="collapse"
																data-target="#innertitleb"><?php echo $course; ?>
										...
										<div class="wt-educationholder tab-pane active fade show" id="wt-education" >
											<div class="wt-userexperience wt-tabsinfo">
												<div class="wt-tabscontenttitle wt-addnew" style="margin-top: 30px;">
														...
														<div class="wt-collapseexp collapse show" id="innertitle"
															...
															<form method="POST" action="#" class="wt-formtheme wt-userform">
																<fieldset>
																	...
																	<div class="form-group ">
																		<input type="text" name="coll_name" class="form-control" placeholder="Collage/Institute Name *" required  >
																	</div>
																	<div class="form-group ">
																		<input type="text" name="course" class="form-control" placeholder="Degree/Diploma/Course Name *" required>
																	</div>
