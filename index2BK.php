									...
									<div class="wt-signupholder">
										<div class="col-12 col-sm-12 col-md-12 col-lg-6 pull-right">
											<div class="wt-signupcontent">
												<div class="wt-title">
													<h2><span>Signup as</span>Crunilance Pro</h2>
												</div>
												<div class="wt-description">
													<p>Consectetur adipisicing elit amissed dotem eiusmod tempor
														incuntes utneai labore etdolore.</p>
												</div>
												<div class="wt-btnarea">
													<a href="signup.php" class="wt-btn wt-btnvtwo">Join Now</a>
													<a href="#" class="wt-btn">What’s new</a>
												</div>
											</div>
										</div>
									</div>
										...
										<div id="filter-masonry" class="wt-teamfilter wt-haslayout">
											<div class="wt-sectionhead">
												<div class="wt-sectiontitle">
													<h2>Our Crunilancers</h2>
													<span>Find expert here</span>
												</div>
											</div>
